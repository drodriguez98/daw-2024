...
--
-- Host: localhost    Database: tarea08
-- ------------------------------------------------------
...
CREATE TABLE `familias` (
  `cod` varchar(6) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `productos` (
  ...
  `familia` varchar(6) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `nombre_corto` (`nombre_corto`),
  KEY `fk_prod_fam` (`familia`),
  CONSTRAINT `fk_prod_fam` FOREIGN KEY (`familia`) REFERENCES `familias` (`cod`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `stocks` (
  ...
  KEY `fk_stock_tienda` (`tienda`),
  CONSTRAINT `fk_stock_prod` FOREIGN KEY (`producto`) REFERENCES `productos` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_stock_tienda` FOREIGN KEY (`tienda`) REFERENCES `tiendas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tiendas` (
  ...
  `tlf` varchar(13) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2025-03-01 18:33:01
